...
[ACL (access-control list) authorization](/operations/acl/) or identities in the
...
1. the first **URI SAN** (Subject Alternative Name; compatible with
   SPIFFE); if this is not present,
