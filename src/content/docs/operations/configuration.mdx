...
| `-tls-client-ca` | `MONOLOCK_TLS_CLIENT_CA` | _(empty)_ | PEM certificate-authority (CA) pool for client certificates; enables mutual TLS (mTLS) |
...
- the [ACL (access-control list) file](/operations/acl/#reload)
